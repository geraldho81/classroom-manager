...
const navigation = [
  ...
  { name: 'Display Mode', href: '/display', icon: Monitor, color: 'text-indigo-500', tooltip: 'Fullscreen projector dashboard — clock, timer, voice level, activity.' },
  { name: 'Timer', href: '/timer', icon: Timer, color: 'text-blue-500', tooltip: 'Set countdown or count-up timers for activities.' },
  { name: 'Agenda', href: '/agenda', icon: CalendarClock, color: 'text-violet-500', tooltip: 'Chain timed lesson segments that auto-advance with a sound cue.' },
  { name: 'Stopwatch', href: '/stopwatch', icon: TimerReset, color: 'text-indigo-500', tooltip: 'Count-up stopwatch with lap splits for races and drills.' },
  { name: 'Countdown', href: '/countdown', icon: Rocket, color: 'text-orange-500', tooltip: 'Big 5-4-3-2-1 transition screen for the projector.' },
  ...
  { name: 'Seating', href: '/seating', icon: Armchair, color: 'text-teal-500', tooltip: 'Build and save a seating chart per class.' },
  { name: 'Attendance', href: '/attendance', icon: ClipboardCheck, color: 'text-teal-600', tooltip: 'Take daily attendance and review a 7-day history.' },
  { name: 'Behavior', href: '/behavior', icon: Star, color: 'text-emerald-500', tooltip: 'Award or deduct points per student with reasons.' },
  { name: 'Hall Pass', href: '/hall-pass', icon: DoorOpen, color: 'text-amber-600', tooltip: 'Sign students out and track how long they are gone.' },
  { name: 'Badges', href: '/badges', icon: Medal, color: 'text-amber-500', tooltip: 'Award digital reward badges from a preset catalog.' },
  { name: 'Pick Me!', href: '/picker', icon: Users, color: 'text-purple-500', tooltip: 'Randomly select students to participate.' },
  { name: 'Spinner', href: '/spinner', icon: Disc3, color: 'text-fuchsia-500', tooltip: 'Visual spinning wheel — picks a student with flair.' },
  { name: 'Line-Up', href: '/lineup', icon: ListOrdered, color: 'text-violet-500', tooltip: 'Shuffle the class into a fair ordered line-up.' },
  { name: 'Shh! Meter', href: '/noise', icon: Volume2, color: 'text-cyan-600', tooltip: 'Monitor classroom noise levels in real-time.' },
  { name: 'Voice Level', href: '/voice-level', icon: TrafficCone, color: 'text-red-500', tooltip: 'Display expected voice volume: silent, whisper, partner, group.' },
  { name: 'Dice & Coin', href: '/dice', icon: Dices, color: 'text-orange-500', tooltip: 'Roll dice or flip coins for activities.' },
  { name: 'Scoreboard', href: '/scoreboard', icon: Trophy, color: 'text-rose-500', tooltip: 'Team score keeper with +/- buttons and a leader crown.' },
  { name: 'Soundboard', href: '/soundboard', icon: Music, color: 'text-amber-500', tooltip: 'Tap-to-play sound effects for reactions.' },
  { name: 'Clap & Echo', href: '/clap-echo', icon: Hand, color: 'text-amber-600', tooltip: 'Play a clap rhythm for the class to echo back.' },
